...
/**
 * Representa una formación continuada.
 * Extiende la funcionalidad de {@link SolicitudConId} e implementa la interfaz {@link FormacionContinuada}.
 * 
 * Esta entidad está mapeada a la base de datos con un valor de discriminador "Formacion continuada".
 * Contiene información específica como el tiempo máximo permitido y la escala asociada.
 * 
