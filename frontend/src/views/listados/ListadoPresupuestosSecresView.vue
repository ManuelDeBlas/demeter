  ...
  export default {
    ...
    methods: {
      ...
      async anhadirNuevoPresupuesto(presupuesto) {
        console.log("Añadiendo nuevo presupuesto:", presupuesto);
      ...
      async editarPresupuesto(presupuesto) {
        this.mostrarModal = true;
        this.mensajeModal = "";
        await this.editarElemento(presupuesto);
        this.mensajeModal = "Presupuesto actualizado correctamente.";
        this.nuevosValores[presupuesto._links.self.href] = "";
      },
      cerrarModal() {
    ...
    <table class="table-auto w-full border border-gray-300 mb-4">
      ...
      <tbody>
        ...
        >
          ...
          <td class="px-2 py-2">
            <input
              ...
              placeholder="Cantidad en céntimos"
            />
          </td>
          <td class="px-4 py-2">
            <button
              @click="
                editarPresupuesto({
                  ...presupuesto,
                  cantidadCentimos:
                    parseInt(nuevosValores[presupuesto._links.self.href]) ||
        ...
        <tr class="">
          ...
          <td class="px-4 py-2">
            <button
              @click="anhadirNuevoPresupuesto({ anho, cantidadCentimos })"
