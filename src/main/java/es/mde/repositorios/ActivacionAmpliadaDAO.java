...
/**
 * Repositorio JPA para gestionar las activaciones ampliadas.
 * Proporciona métodos CRUD para la entidad {@link ActivacionAmpliadaConId}.
 * 
 * Este repositorio está expuesto como un recurso REST con el path "activaciones-ampliadas".
 * 
