<script>
  import { getStorePorTipoListado } from "@/utils/utils";
  ...
  export default {
    ...
    created() {
      this.store = getStorePorTipoListado(this.tipoListado);
      this.cargado = true;
    },
    ...
    methods: {
      abrirElemento() {
        ...
        this.store.elementoAbierto = this.elemento; // Guarda el elemento en el store para editarlo
        this.$router.push({
          ...
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 text-start">
              <div class="mb-0" v-if="tipoListado === 'solicitudes'">
                DNI:
                <strong>{{ elemento.reservista.dni }}&nbsp; </strong> &nbsp;
